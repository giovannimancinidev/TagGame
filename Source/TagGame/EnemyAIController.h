...
protected:
    ...
    TSharedPtr<FAivState> GoToPlayerState;
    TSharedPtr<FAivState> GoToBallState;
    TSharedPtr<FAivState> TryToGrabBallState;
    TSharedPtr<FAivState> SearchFreeBallState;

    void BeginPlay() override;
    void Tick(float DeltaTime) override;

    ABallGrab* TargetBall;
};